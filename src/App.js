...
import waitingGif from './assests/icons/waiting.gif'
function App() {
  ...
  return (
    <div className="App" style={WeatherData && {background: "linear-gradient(125deg, #caf4ed 0%, #9a02db)" ,height:"100%"}}>
        ...
        (<div className='result-page'>
          {WeatherData ? (
            ...
            <div className="landingPage">
              <img src={waitingGif} height={"90%"} width={"75%"} alt="gif" />
              <div className="weather" style={{ fontSize: "2rem", color: "black", alignItems: "center" }}>I am Waiting !!</div>
            </div>
          )}
          {ForeCastData ? (
          ...
          <img src={waitingGif} height={"90%"} width={"75%"} alt="gif" />
          <div className="weather" style={{ fontSize: "2rem", color: "black", alignItems: "center" }}>Oh got it. Just a second </div>
        </div>)}
    </div>
  );
}
